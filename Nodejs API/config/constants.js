...
module.exports.USERGROUP_NOT_FOUND = `usergroup can't be empty.`;
...
module.exports.SEND_REQUEST_FAILED = `Request failed.`;
module.exports.SEND_REQUEST_OK = `Request sent.`;
